...
export const RISK_RULES: RiskRule[] = [
  ...
  { id: 'RULE_MISSING_REQUIRED_DOC', code: 'MISSING_REQUIRED_DOC', name: 'Tələb olunan sənəd çatışmır',       description: 'Bu bəyannamə növü/şəxs növü üçün məcburi sənəd əlavə edilməyib.',           weight: 25, severity: 'critical', category: 'documents',  active: true },
  { id: 'RULE_VALIDATION_FAIL',      code: 'VALIDATION_FAIL',      name: 'Sistem validasiyası uğursuz',       description: 'Bəyannamə L1 sistem validasiyasından keçməyib (sahə/sənəd/fayl səhvi).',    weight: 30, severity: 'critical', category: 'documents',  active: true },
  ...
  { id: 'RULE_INVOICE_CCY_MM',       code: 'INVOICE_CURRENCY_MISMATCH', name: 'Invoys valyutası uyğun deyil', description: 'Hesab-faktura valyutası bəyannamə valyutasından fərqlidir.',             weight: 10, severity: 'warning',  category: 'value',      active: true },
  ...
  { id: 'RULE_HS_INTRA_MM',          code: 'HS_CODE_INTRA_MISMATCH', name: 'HS kodu sənədlər arası uyğunsuz', description: 'Gömrük bəyannaməsindəki HS kodu ümumi HS kodundan fərqlidir.',              weight: 20, severity: 'critical', category: 'documents',  active: true },
