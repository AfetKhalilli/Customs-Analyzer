...
// Azerbaijani labels for the internal rule-category enum keys.
const RULE_CATEGORY_AZ: Record<string, string> = {
  shipment:  'Daşıma',
  value:     'Dəyər',
  documents: 'Sənədlər',
  origin:    'Mənşə',
  reference: 'İstinad reyestri',
};
                ...
                <tbody>
                  {RISK_RULES.map((r) => (
                    <tr key={r.id} style={{ cursor: 'default' }}>
                      ...
                      <td>{RULE_CATEGORY_AZ[r.category] ?? r.category}</td>
